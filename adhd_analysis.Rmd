---
title: "ADHD - logistic regression"
...
`74.21.`, `74.55.`, `114.6.`, `114.40.`, `116.47.`, `116.55.`, `134.23.`, `134.99.`, `138.23.`, `138.107.`, `173.47.` and `189.65.` have both negative and positive effects on probability of having ADHD in different models.
...
`corr` matrix shows the correlation between the features. The most positively correlated features are `114.6.` and `114.40.` with correlation 0.6400897. The most negatively correlated ones are `126.2.` and `134.23.` with correlation -0.27801636.
...
`intensity` matrix shows the number of times that the features appear in the same model. The most connected pair of features are the most frequent ones. 
...
The resulting network is shown in the figure above.

### Appendix

The features in the frequency table are ordered in a way that they are given in the dataset.